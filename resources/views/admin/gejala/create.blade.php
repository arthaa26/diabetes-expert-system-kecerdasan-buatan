...
<div class="min-h-screen bg-gray-100 p-6">
    <div class="max-w-2xl mx-auto">
        ...
        <div class="mb-6">
            ...
            <h1 class="text-3xl font-bold text-gray-800 mt-2">Tambah Gejala</h1>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <form action="{{ route('admin.gejala.store') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <textarea name="nama_gejala" placeholder="Contoh: Cepat Lapar dan Haus" rows="4"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                        required>{{ old('nama_gejala') }}</textarea>
                    @error('nama_gejala')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                </div>
